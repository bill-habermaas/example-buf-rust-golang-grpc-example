// Code generated by protoc-vendor-connect-go. DO NOT EDIT.
//
...
var (
	explorerServiceServiceDescriptor       = explorer_v1.File_proto_explorer_v1_explorer_proto.Services().ByName("ExplorerService")
