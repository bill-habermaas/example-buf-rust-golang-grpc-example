...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/bufbuild/explorer/gen/proto/explorer/v1"
	http "net/http"
	strings "strings"
)
...
var (
	explorerServiceServiceDescriptor       = v1.File_proto_explorer_v1_explorer_proto.Services().ByName("ExplorerService")
...
type ExplorerServiceClient interface {
	Explore(context.Context, *connect.Request[v1.ExplorerRequest]) (*connect.Response[v1.ExplorerResponse], error)
}
...
func NewExplorerServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ExplorerServiceClient {
	...
	return &explorerServiceClient{
		explore: connect.NewClient[v1.ExplorerRequest, v1.ExplorerResponse](
			httpClient,
...
type explorerServiceClient struct {
	explore *connect.Client[v1.ExplorerRequest, v1.ExplorerResponse]
}

// Explore calls explorer.v1.ExplorerService.explore.
func (c *explorerServiceClient) Explore(ctx context.Context, req *connect.Request[v1.ExplorerRequest]) (*connect.Response[v1.ExplorerResponse], error) {
...
func (UnimplementedExplorerServiceHandler) Explore(context.Context, *connect.Request[v1.ExplorerRequest]) (*connect.Response[v1.ExplorerResponse], error) {
